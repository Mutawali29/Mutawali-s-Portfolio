            ...
            {showFrontPage ? (
                ...
                <div>
                    ...
                    <motion.div
                        ...
                        className="absolute mt-[-500px] ml-[-20px]  sm:mt-[-560px] sm:ml-8 ls:ml-24 ll:ml-44 lg:ml-80 opacity-20"
                    >
                        <img src={img} alt="img" className="h-[-300px]  sm:h-[650px] opacity-30 mt-20" />
                    </motion.div>
                </div>
                </>
            )}
