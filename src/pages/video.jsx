    ...
    return (
        <>
            ...
            <motion.div
                ...
                animate={{ opacity: showVidPage ? 0 : 1, scale: 1 }}
                exit={{ opacity: 0, scale: 0.65 }}
                transition={{ duration: 0.5 }}
                className="absolute mt-[-270px] sm:ml-20 ls:ml-32 ll:ml-52 lg:mt-[-360px] ml-2 lg:ml-80 opacity-20"
            >
                <img src={img} alt="img" className="h-[300px] lg:h-[450px] ml-24 opacity-30" />
            </motion.div>
        </>
    );
};
