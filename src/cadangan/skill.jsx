...
const Skill = () => {
    ...
    return (
        <div id="skill" className="h-screen w-screen bg-gradient-to-r from-gray-950 via-gray-800 to-gray-950 text-white flex flex-col justify-center items-center">
            <div className="mb-16">
                <motion.div
                    ref={ref}
                    initial="hidden"
            ...
            <div className="flex justify-center items-start space-x-16">
                ...
                <div className="flex flex-col space-y-8">
                    <motion.div
                        ...
                        transition={{ ...morphStyle.transition, delay: 0 }}
                    ...
                    <motion.div
                        initial={morphStyle.initial}
                        animate={hasAnimated ? morphStyle.animate : morphStyle.initial}
                        transition={{ ...morphStyle.transition, delay: 1 }} // Updated delay for the second element
                        className="text-center p-6 bg-gradient-to-r from-gray-700 to-gray-900 rounded-lg shadow-lg"
                    >
